                            ...
                            <div class="col-xl-6">
                                <div class="product_det_text">
                                    ...
                                    <div class="details_quentity_area">
                                        <p><span>{{ __('Qti') }} </span> (in {{ $wishlist->products->unitType }}) :</p>
                                    ...
                                    <div class="details_cart_btn">
                                        <a class="common_btn" href="#"><i class="far fa-shopping-basket"></i> {{ __('Add To
                                            Cart') }}
                                            <span></span></a>
                                        <a class="love" href="{{ route('adToWishlist',$wishlist->products->id) }}"><i class="far fa-heart"></i></a>
                                    </div>
                                    <p class="category"><span>{{ __('Category') }}:</span> {{ $wishlist->products->productcategories->name }}</p>
                                    <ul class="tags">
                                        <li>{{ __('Tags') }}:</li>
