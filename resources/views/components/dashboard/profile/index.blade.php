 <div class="card">
     <div class="card-header p-2">
         <ul class="nav nav-pills">
             <li class="nav-item"><a class="nav-link active" href="#profileSetting" data-toggle="tab">{{ __('Profile') }}</a></li>
             <li class="nav-item"><a class="nav-link" href="#passwordSetting" data-toggle="tab">{{ __('Password') }}</a></li>
         </ul>
     </div><!-- /.card-header -->
     <div class="card-body">
