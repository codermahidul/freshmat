    ...
    <div class="card">
        <div class="card-header p-2">
            <ul class="nav nav-pills">
                <li class="nav-item"><a class="nav-link active" href="#profileSetting"
                        data-toggle="tab">{{ __('Profile') }}</a></li>
                <li class="nav-item"><a class="nav-link" href="#passwordSetting" data-toggle="tab">{{ __('Password') }}</a>
                </li>
            </ul>
        </div><!-- /.card-header -->
        <div class="card-body">
                ...
                <div class="tab-pane active" id="profileSetting">
                    <form class="form-horizontal" action="{{ route('profileUpdate') }}" method="POST"
                        ...
                        <div class="form-group row w-50">
                            <label for="name" class="col-sm-2 col-form-label">{{ __('Photo') }}</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="phone" class="form-control" id="phone"
                                    placeholder="Phone" value="{{ Auth::user()->userProfile->phone }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="city" class="form-control" id="city" placeholder="City"
                                    value="{{ Auth::user()->userProfile->city }}">
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <form class="form-horizontal" action="{{ route('passwordUpdate') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="current_password"
                                class="col-sm-2 col-form-label">{{ __('Current Password') }}</label>
                            <div class="col-sm-10">
