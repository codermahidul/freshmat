                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror"
                                        ...
                                        value="{{ old('address') }}{{ $deliveryLocation->address }}">
                                    @error('address')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('charge') is-invalid @enderror"
                                        ...
                                        value="{{ old('charge') }}{{ $deliveryLocation->charge }}">
                                    @error('charge')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                <option value="active" {{ $deliveryLocation->status == 'active' ? 'selected' : '' }}>
                                    {{ __('Active') }}</option>
                                <option value="deactive"
                                    {{ $deliveryLocation->status == 'deactive' ? 'selected' : '' }}>
                                    {{ __('Deactive') }}</option>
                            </select>
                        </div>
