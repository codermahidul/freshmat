      ...
      <div class="row">
        <div class="col-5 col-sm-3">
          <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" id="vert-tabs-social-login-tab" data-toggle="pill" href="#vert-tabs-social-login" role="tab" aria-controls="vert-tabs-social-login" aria-selected="false">Social Login</a>
