    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Home One Deals</h2>
            </div>
            <div class="card-body">
                <form action="{{ route('homeOneDealsUpdate') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="shortTitle" id="shortTitle" class="form-control" placeholder="Short Title" value="{{ deals(1)->shortTitle }}">
                        @error('shortTitle')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="offerText" id="offerText" class="form-control" placeholder="Offer Text" value="{{ deals(1)->offerText }}">
                        @error('offerText')
                            <span class="text-danger">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="date" id="date" class="form-control" value="{{ old('date', deals(1)->date) }}">
                        @error('date')
                            <span class="text-danger">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="link" id="link" class="form-control" placeholder="Link" value="{{ deals(1)->link }}">
                        @error('link')
                            <span class="text-danger">
                                {{ $message }}
                            </span>
