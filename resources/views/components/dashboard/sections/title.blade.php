      ...
      <div class="row">
        <div class="col-5 col-sm-3">
          <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link active" id="vert-tabs-home-tab" data-toggle="pill" href="#vert-tabs-home" role="tab" aria-controls="vert-tabs-home" aria-selected="true">{{ __('Home Page (One)') }}</a>
            @endif
            @if (setting('theme') == 'all' || setting('theme') == 'two')
            <a class="nav-link" id="vert-tabs-messages-tab" data-toggle="pill" href="#vert-tabs-messages" role="tab" aria-controls="vert-tabs-messages" aria-selected="false">{{ __('Home Page (Two)') }}</a>
            @endif
            @if (setting('theme') == 'all' || setting('theme') == 'three')
            <a class="nav-link" id="vert-tabs-settings-tab" data-toggle="pill" href="#vert-tabs-settings" role="tab" aria-controls="vert-tabs-settings" aria-selected="false">{{ __('Home Page (Three)') }}</a>
            @endif

            <a class="nav-link" id="vert-tabs-profile-tab" data-toggle="pill" href="#vert-tabs-profile" role="tab" aria-controls="vert-tabs-profile" aria-selected="false">{{ __('About Us') }}</a>
          </div>
        </div>
        <div class="col-7 col-sm-9">
          <div class="tab-content" id="vert-tabs-tabContent">
            <div class="tab-pane text-left fade show active" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
               <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ __('Our Product Section') }}</h2>
                </div>
                <div class="card-body">
               ...
               <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ __('Our Partners Section') }}</h2>
                </div>
                <div class="card-body">
               ...
               <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ __('Our Special Products Section') }}</h2>
                </div>
                <div class="card-body">
               ...
               <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ __('Testimonial Section') }}</h2>
                </div>
                <div class="card-body">
               ...
               <div class="card">
                <div class="card-header">
                    <h2 class="card-title">{{ __('Blog & News Section') }}</h2>
                </div>
                <div class="card-body">
            ...
            <div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Feature Section') }}</h2>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Working Process Section') }}</h2>
                    </div>
                    <div class="card-body">
            ...
            <div class="tab-pane fade" id="vert-tabs-messages" role="tabpanel" aria-labelledby="vert-tabs-messages-tab">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Best Seller Product Section') }}</h2>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Special Product Section') }}</h2>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Testimonial') }}</h2>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Blog') }}</h2>
                    </div>
                    <div class="card-body">
            ...
            <div class="tab-pane fade" id="vert-tabs-settings" role="tabpanel" aria-labelledby="vert-tabs-settings-tab">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Category') }}</h2>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">{{ __('Product filter') }}</h2>
                    </div>
                    <div class="card-body">
