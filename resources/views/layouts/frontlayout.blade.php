...
<body class="{{ setting('theme') == 'two' ? 'home_2' : '' }} {{ setting('theme') == 'three' ? 'home_3' : '' }}">
    ...
    @if (setting('topbar') == 'show')
        <section
            class="topbar {{ setting('theme') == 'two' ? 'topbar_2' : '' }} {{ setting('theme') == 'three' ? 'topbar_3' : '' }}">
            <div class="container">
                <div class="row">
    ...
    ==========================-->
    <nav
        class="main_menu  {{ setting('theme') == 'two' ? 'main_menu_2' : '' }} {{ setting('theme') == 'three' ? 'main_menu_3' : '' }} d-none d-lg-block">
        <div class="container">
            <div class="row">
                ...
                <ul>
                    @if (Session::has('cart'))
                        @foreach (Session::get('cart') as $cart)
                            <li>
                                <div class="cart_img">
                                    <img src="{{ asset($cart['thumbnail']) }}" alt="product"
                                        class="img-fluid w-100">
                                    <a class="wsis__del_icon"
                                        href="{{ route('removeCartItem', $cart['productId']) }}"><i
                                            class="fas fa-minus-circle"></i></a>
                                </div>
                                <div class="cart_text">
                                    <a class="cart_title"
                                        href="{{ route('productDetails', productSlug($cart['productId'])) }}">
                                        {{ $cart['title'] }} </a>
                    ...
                    <div class="row wow fadeInUp">
                        <div class="col-lg-3 col-sm-6">
                            <div class="footer_info_item">
                                <div class="icon">
                                    <img src="{{ asset(footerTop(1)->icon) }}" alt="Icon"
                                        class="img-fluid w-100">
                                </div>
                                <div class="text">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="footer_info_item">
                                <div class="icon">
                                    <img src="{{ asset(footerTop(2)->icon) }}" alt="Icon"
                                        class="img-fluid w-100">
                                </div>
                                <div class="text">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="footer_info_item">
                                <div class="icon">
                                    <img src="{{ asset(footerTop(3)->icon) }}" alt="Icon"
                                        class="img-fluid w-100">
                                </div>
                                <div class="text">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="footer_info_item">
                                <div class="icon">
                                    <img src="{{ asset(footerTop(4)->icon) }}" alt="Icon"
                                        class="img-fluid w-100">
                                </div>
                                <div class="text">
                    ...
                    <div class="col-lg-3 col-md-8">
                        <div class="footer_logo_area">
                            <a class="footer_logo" href="{{ route('index') }}">
                                <img src="{{ asset(setting('footerLogo')) }}" alt="Freshmat"
                                    class="img-fluid w-100">
                            </a>
