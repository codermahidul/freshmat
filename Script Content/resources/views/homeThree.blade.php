...
@section('content')
                                ...
                                <div class="col-xl-12">
                                    <div class="single_slider" style="background: url({{ asset($slider->backgroundImg) }});">
                                        <div class="single_slider_text">
                                            ...
                                            <a class="common_btn" href="{{ $slider->link }}">{{ __('shop now') }}
                                                <span></span></a>
                                        </div>
                                    </div>
                                </div>
                            @empty
                                {{ __('No Slider Item found!') }}
                            @endforelse
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="banne_3_add_item" style="background: url({{ asset(banner(11)->backgroundImg) }})">
                                <div class="text">
                                    ...
                                    <a class="common_btn" href="{{ banner(11)->link }}">{{ __('shop now') }}
                                        <span></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-6">
                            <div class="banne_3_add_item" style="background: url({{ asset(banner(12)->backgroundImg) }})">
                                <div class="text">
                                    ...
                                    <a class="common_btn" href="{{ banner(12)->link }}">{{ __('shop now') }}
                                        <span></span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="add_banner_item" style="background: url({{ asset(banner(13)->backgroundImg) }})">
                        <div class="add_banner_item_text">
                            ...
                            <a class="common_btn" href="{{ banner(13)->link }}">{{ __('shop now') }} <span></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="add_banner_item" style="background: url({{ asset(banner(14)->backgroundImg) }})">
                        <div class="add_banner_item_text">
                            ...
                            <a class="common_btn" href="{{ banner(14)->link }}">{{ __('shop now') }} <span></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
        ...
        <div class="container">
            ...
            <div class="row grid">
                @foreach ($latestProduct as $product)
                    <div
                        class="col-xl-3 col-sm-6 col-lg-4 {{ $product->productcategories->slug . $product->productcategories->id }}">
                                        ...
                                        <div class="product_det_text">
                                            ...
                                            <div class="details_quentity_area">
                                                ...
                                                <div class="button_area">
                                                    ...
                                                    <input type="text" value="{{ cartQti($product->id) }}"
                                                        class="quantity" name="quantity">
                                                    <button class="increment" type="button">+</button>
                                                    <input value="{{ $product->selePrice }}" type="hidden"
                                                        class="selePrice">
                                                </div>

                                                <h3>= $<span
                                                        class="mathPrice">{{ $product->selePrice * cartQti($product->id) }}</span>
                                                </h3>
                                            </div>
                                            <div class="details_cart_btn">
                                                <button type="submit" class="common_btn"><i class="far fa-shopping-basket"></i> {{ __('Add To Cart') }}
                                                    <span></span></button>
                                            ...
                                            <p class="category">
                                                <span>{{ __('Category') }}:</span>{{ $product->productcategories->name }}</p>
                                            <ul class="share">
                                                <li>{{ __('Share with friends') }}:</li>
                                                <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ route('productDetails', $product->slug) }}&t={{ $product->title }}"
                                                        target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a
                                                        href="https://twitter.com/share?text={{ $product->title }}&url={{ route('productDetails', $product->slug) }}"><i
                                                            class="fab fa-twitter" target="_blank"></i></a></li>
                                                <li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{ route('productDetails', $product->slug) }}&title={{ $product->title }}"
            ...
            <div class="row">
                <div class="col-xxl-5 col-md-9 col-lg-7 col-xl-6">
                    <div class="countdown_text">
                        ...
                        <a class="common_btn" href="{{ deals(3)->link }}">{{ __('shop now') }} <span></span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5 col-md-5">
                    <div class="testimonial_3_img">
                        <img src="{{ asset('assets') }}/images/testimonial_3_large_img.png" alt="testimonial"
    ...
    <!--=========================
            VIDEO START
        ==========================-->
    <section class="video pt_115 xs_pt_75 pb_115 xs_pb_75"
        style="background: url({{ asset($backgroundVideo->backgroundImg) }}">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10">
                    <div class="video_content">
                        <div class="text">
                            ...
                            <a class="common_btn" href="{{ $backgroundVideo->link }}">{{ __('shop now') }}</a>
                        </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-xxl-5 col-lg-6">
                        <div class="download_text">
                            ...
                            <ul>
                                <li>
                                    <a class="common_btn" href="{{ appSection()->appleLink }}"><i class="fab fa-apple"
                                            aria-hidden="true"></i> {{ __('Apple Store') }}
