                    ...
                    <form action="{{ route('contactMessageSetingUpdate') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control"
                                placeholder="Enter Your Email" value="{{ setting('messageReceiveEmail') }}">
                            @error('email')
                        ...
                        <div class="form-group">
                            ...
                            <select name="dbsave" id="dbsave" class="form-control">
                                <option value="yess" @if (setting('messageSaveOnDB') == 'yess') selected @endif>{{ __('Yess') }}
                                </option>
                                <option value="no" @if (setting('messageSaveOnDB') == 'no') selected @endif>{{ __('No') }}
                                </option>
                            </select>
                            @error('dbsave')
                                <span class="text-danger d-block">{{ $message }}</span>
                            ...
                            @forelse ($messages as $message)
                                <tr class="@if ($message->status == 'read') table-light @endif">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('messageView', $message->id) }}" class="btn-sm btn-primary"><i
                                                class="fas fa-eye"></i></a>
                                        <a href="{{ route('messageDelete', $message->id) }}" class="btn-sm btn-danger delete-item"><i
